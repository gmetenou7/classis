...
const SignIn: React.FC = () => {
  const { handleSubmitFn, mutation, errors, register } = useAuthForm({
    schema,
    mutationKey: ["sign-in", 1],
    apiRoute: "/api/sign-in",
  });
  return (
    <>
      <Head>
        <title>Connexion | Classis</title>
        <meta name="description" content="This is login page for Classis" />
      </Head>
      <span className="mb-1.5 block font-medium">Heureux de vous revoir!</span>
      <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
        Connectez vous à Classis
      </h2>
      ...
      <form onSubmit={handleSubmitFn}>
        ...
        <div className="mb-6">
          <p className="mb-2.5 flex justify-between font-medium text-black dark:text-white">
